...
void Lab2::Init()
{
...

	{
		...
		{
			// T1
			VertexFormat(glm::vec3(1, 1, 2), glm::vec3(0, 0, 1), glm::vec3(0, 0, 0)), // 0 0 1
			VertexFormat(glm::vec3(2, 1, 1), glm::vec3(0, 0, 1), glm::vec3(0, 0, 0)), // 1 0 0
			VertexFormat(glm::vec3(2, 2, 2), glm::vec3(0, 0, 1), glm::vec3(0, 0, 0)), // 1 1 1

			// T2
			VertexFormat(glm::vec3(1, 1, 2), glm::vec3(1, 0, 0), glm::vec3(0, 0, 0)), // 0 0 1
			VertexFormat(glm::vec3(2, 2, 2), glm::vec3(1, 0, 0), glm::vec3(0, 0, 0)), // 1 1 1
			VertexFormat(glm::vec3(1, 2, 1), glm::vec3(1, 0, 0), glm::vec3(0, 0, 0)), // 0 1 0

			// T3
			VertexFormat(glm::vec3(1, 1, 2), glm::vec3(0, 1, 0), glm::vec3(0, 0, 0)), // 0 0 1
			VertexFormat(glm::vec3(1, 2, 1), glm::vec3(0, 1, 0), glm::vec3(0, 0, 0)), // 0 1 0
			VertexFormat(glm::vec3(2, 1, 1), glm::vec3(0, 1, 0), glm::vec3(0, 0, 0)), // 1 0 0

			// T4
			VertexFormat(glm::vec3(2, 2, 2), glm::vec3(1, 1, 0), glm::vec3(0, 0, 0)), // 1 1 1
			VertexFormat(glm::vec3(2, 1, 1), glm::vec3(1, 1, 0), glm::vec3(0, 0, 0)), // 1 0 0
			VertexFormat(glm::vec3(1, 2, 1), glm::vec3(1, 1, 0), glm::vec3(0, 0, 0)) // 0 1 0
		};
...

	{
		...
		{
			// T1
			VertexFormat(glm::vec3(1, 1, 2), glm::vec3(1, 1, 1), glm::vec3(0, 0, 0)), // 0 0 1
			VertexFormat(glm::vec3(2, 1, 2), glm::vec3(1, 1, 1), glm::vec3(0, 0, 0)), // 1 0 0
			VertexFormat(glm::vec3(2, 2, 2), glm::vec3(1, 1, 1), glm::vec3(0, 0, 0)), // 1 1 1

			// T2
			VertexFormat(glm::vec3(1, 1, 2), glm::vec3(1, 1, 1), glm::vec3(0, 0, 0)), // 0 0 1
			VertexFormat(glm::vec3(2, 2, 2), glm::vec3(1, 1, 1), glm::vec3(0, 0, 0)), // 1 1 1
			VertexFormat(glm::vec3(1, 2, 2), glm::vec3(1, 1, 1), glm::vec3(0, 0, 0)), // -1 -1 -1
...
void Lab2::Update(float deltaTimeSeconds)
{
	...
	RenderMesh(meshes["cube_A"], shaders["VertexColor"], glm::vec3(-1.5f, 0.5f, 0), glm::vec3(1));

	// TODO(student): Draw the mesh that was created with `CreateMesh()`
	RenderMesh(meshes["cube_B"], shaders["VertexColor"], glm::vec3(-1.5f, 0.5f, 0), glm::vec3(1));

	// TODO(student): Draw the tetrahedron
	RenderMesh(meshes["tetrahedron"], shaders["VertexColor"], glm::vec3(0, 0, 0), glm::vec3(1));

	// TODO(student): Draw the square
	RenderMesh(meshes["square"], shaders["VertexColor"], glm::vec3(2, 0.5f, 0), glm::vec3(1));
