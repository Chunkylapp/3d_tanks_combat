...
void Lab5::FrameEnd()
{
    if (flagg)
        ...
        projectionMatrix = glm::ortho(-0.5f * window_size, 0.5f * window_size, 0.5f * window_size, -0.5f * window_size, 0.f, 10.0f);
...
void Lab5::OnMouseMove(int mouseX, int mouseY, int deltaX, int deltaY)
{
    ...
    if (window->MouseHold(GLFW_MOUSE_BUTTON_RIGHT))
    {
        ...
        if (window->GetSpecialKeyState() == 0) {
            ...
            //camera->RotateFirstPerson_OZ(-sensivityOX * deltaX);
        }
