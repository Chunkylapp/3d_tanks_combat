    ...
    class Camera
    {
     public:
        ...
        void TranslateForward(float distance)
        {
            ...
            // `MoveForward()`?
            this->position = position + glm::normalize(forward) * distance;
        ...
        void TranslateUpward(float distance)
        {
            ...
            this->position = position + glm::normalize(up) * distance;
        }
        ...
        void TranslateRight(float distance)
        {
            ...
            this->position = position + glm::normalize(right) * distance;
        ...
        void RotateFirstPerson_OX(float angle)
        {
            ...
            glm::vec4 rotation = glm::rotate(glm::mat4(1.0f), angle, right) * glm::vec4(forward, 1);
            forward = glm::normalize(glm::vec3(rotation));

			rotation = glm::rotate(glm::mat4(1.0f), angle, right) * glm::vec4(up, 1);
			up = glm::normalize(glm::vec3(rotation));
        ...
        void RotateFirstPerson_OY(float angle)
        {
            ...
            // vectors!
			glm::vec4 rotation = glm::rotate(glm::mat4(1.0f), angle, glm::vec3(0, 1, 0)) * glm::vec4(forward, 1);
			forward = glm::normalize(glm::vec3(rotation));

			rotation = glm::rotate(glm::mat4(1.0f), angle, glm::vec3(0, 1, 0)) * glm::vec4(up, 1);
			up = glm::normalize(glm::vec3(rotation));

			rotation = glm::rotate(glm::mat4(1.0f), angle, glm::vec3(0, 1, 0)) * glm::vec4(right, 1);
			right = glm::normalize(glm::vec3(rotation));
        }
        ...
        void RotateFirstPerson_OZ(float angle)
        {
			...
			glm::vec4 rotation = glm::rotate(glm::mat4(1.0f), angle, glm::vec3(0, 0, 1)) * glm::vec4(up, 1);
			up = glm::normalize(glm::vec3(rotation));

			rotation = glm::rotate(glm::mat4(1.0f), angle, glm::vec3(0, 0, 1)) * glm::vec4(right, 1);
			right = glm::normalize(glm::vec3(rotation));
        ...
        void RotateThirdPerson_OX(float angle)
        {
			...
			this->TranslateForward(1 * distanceToTarget);
